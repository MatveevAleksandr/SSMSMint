...
namespace SSMSMint.Shared.Services
{
    ...
    public class FrameService
    {
        ...
        /// </summary>
        public List<IGridControl> GetAllGridControls()
        {
            try
            {
        ...
        /// </summary>
        private IGridControl GetLastActiveGridControl()
        {
            try
            {
        ...
        /// </summary>
        private IVsWindowFrame GetActiveWindowFrame()
        {
            try
            {
        ...
        /// </summary>
        public IGridControl GetLastFocusedOrFirstGridControl()
        {
            try
            {
        ...
        public IGridControl GetNextGrid(IGridControl grid)
        {
            try
            {
        ...
        public IGridControl GetPrevGrid(IGridControl grid)
        {
            try
            {
        ...
        /// </summary>
        public SqlScriptEditorControl GetSqlScriptEditorControl()
        {
