...
using Microsoft.SqlServer.Management.UnifiedSettings;
using System;
using System.Text;
...
internal class SqlScriptProcessorManagerImpl(ISettingsManager settingsManager) : ISqlScriptProcessorManager
{
    ...
    private string GetUrnScript(Server server, Urn urn)
    {
        ...
        var smoOptions = (Microsoft.SqlServer.Management.Smo.ScriptingOptions)ScriptingOptionsSmo.GetSmoScriptingOptions();
