...
namespace SSMSMint.SSMS2022.ToolWindows;
...
public class ResultsGridSearchToolWindow : ToolWindowPane, IToolWindowCore
{
    /// <summary>
    ...
    {
        this.Caption = "Поиск в таблицах результатов";

        // This is the user control hosted by the tool window; Note that, even if this class implements IDisposable,
        // we are not calling Dispose on this object. This is because ToolWindowPane calls Dispose on
        // the object returned by the Content property.
        this.Content = new ResultsGridSearchControl();
    }

    public void Initialize(IToolWindowParams twParams)
    {
        (this.Content as ResultsGridSearchControl).Initialize(twParams);
    }
}
