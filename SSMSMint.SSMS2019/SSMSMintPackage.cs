...
using SSMSMint.SSMS2019.Commands;
using SSMSMint.SSMS2019.Implementations;
using SSMSMint.SSMS2019.Infrastructure;
using SSMSMint.SSMS2019.Settings;
using SSMSMint.SSMS2019.ToolWindows;
...
{
    private readonly string themeUriStr = "pack://application:,,,/SSMSMint.SSMS2019;component/Resources/MainSSMSTheme.xaml";
