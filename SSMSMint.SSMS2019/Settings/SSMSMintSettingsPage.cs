...
namespace SSMSMint.SSMS2019.Settings;

internal class SSMSMintSettingsPage : DialogPage
{
    [Category("Locate in object explorer")]
    [DisplayName("Enabled")]
    [Description("Enable locate in object explorer")]
    public bool LocateInObjectExplorerEnabled { get; set; } = true;

    [Category("Mixed language in script")]
    [DisplayName("Enabled")]
    [Description("Enable the mixed language verification function in the script")]
    ...
    [Description("The keyword after which the name and the beginning of the region will be determined")]
    public string RegionStartKeyword { get; set; } = "--#region";

    [Category("Regions")]
    [DisplayName("Region end keyword")]
    [Description("The keyword after which the end of the region will be determined")]
    public string RegionEndKeyword { get; set; } = "--#endregion";

    [Category("Results grid search")]
    [DisplayName("Enabled")]
    [Description("Enable the search in the result grids")]
    public bool ResultsGridSearchEnabled { get; set; } = true;

    [Category("Script sql object")]
    [DisplayName("Enabled")]
    [Description("Enable the script generation function for an SQL object")]
